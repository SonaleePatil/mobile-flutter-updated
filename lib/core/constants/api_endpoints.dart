...
class ApiEndpoints {
  ...
  static const String authMePerformanceInsights = '$auth/me/performance-insights';
  static const String authMeActiveParticipations = '$auth/me/active-participations';
  ...
  static const String pushNotificationsReadAll = '$pushNotificationsInbox/read-all';
  static String pushNotificationRead(String id) => '$pushNotificationsInbox/$id/read';
  static String pushNotificationDelete(String id) => '$pushNotificationsInbox/$id';

  // Community posts
  static String communityPosts(String communityId) => '$communities/$communityId/community-posts';
